...
public class TextError extends TextErrorOrWarning {
    ...
    public static final java.lang.String LABEL = "Error";
    ...
    public TextError ( @Nullable java.lang.String id, @NotNull java.lang.String message, @Nullable TextToken token ) {
