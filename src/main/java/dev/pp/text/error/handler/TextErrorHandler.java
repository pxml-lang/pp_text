...
//    void stop();
    ...
    void handleError ( @Nullable java.lang.String id, @NotNull java.lang.String message, @Nullable TextToken token );

    void handleWarning ( @NotNull TextWarning warning );

    void handleWarning ( @Nullable java.lang.String id, @NotNull java.lang.String message, @Nullable TextToken token );
